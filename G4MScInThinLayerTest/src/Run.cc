...
void Run::EndOfRun(RMSPlotter* rmsplotter)
{
  ...
  // LHCb
  if (rmsplotter != nullptr) {
    rmsplotter->AddRun(fEkin, (rmsMsc/mrad));
    // rmsplotter->AddForFitting(fEkin, analysisManager->GetH1(13));
  }
